package com.carros.api.services.demos;

import com.carros.api.services.users.User;
import com.carros.api.services.users.UserDTO;
...
public class DemoJoinController {
  ...
  public ResponseEntity<Object> findUsersByRole(@PathVariable("role") String role) {
...
interface JoinRepository extends JpaRepository<User, Long> {
  ...
  @Query(value = "SELECT u.login,u.email,r.nome FROM User u inner join u.roles r")
